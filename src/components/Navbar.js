      ...
      <>
        <nav className="navbar">
          ...
          <div className='nav_link_div'>
            ...
            <a className="shopping-cart-desktop" href="/cart" aria-label="Shopping Cart">
              <img
                className="cart_nav"
        ...
        <>
          <nav className="navbar">
            ...
            <div className='nav_link_div'>
              ...
              <a className="shopping-cart-tablet" href="/cart" aria-label="Shopping Cart">
                <img
                  className="cart_nav"
                  src="img/shopping-cart2.png"
                  alt="Shopping cart icon"
    ...
    return (
        <>
          <nav className="navbar-mobile">
            ...
            <div className='nav_link_div'>
              <a className="shopping-cart-mobile" href="/cart" aria-label="Shopping Cart">
                <img
                  className="cart_nav"
                  src="img/shopping-cart2.png"
                  alt="Shopping cart icon"
